...
<body>
    ...
    <div>
        <dxwpg:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" EnableCallBacks="False"              
            oncustomchartdatasourcerows="ASPxPivotGrid1_CustomChartDataSourceRows">
            <Fields>
        ...
        <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="ASPxPivotGrid1"
            Height="300px" SeriesDataMember="Series" Width="600px" 
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
            ...
            <diagramserializable>
                <cc1:XYDiagram>
                    <axisx visibleinpanesserializable="-1" title-text="Name">
...
<WholeRange AutoSideMargins="True"></WholeRange>
                    ...
                    <axisy visibleinpanesserializable="-1" title-text="Value">
                        <range sidemarginsenabled="True" />
                    <VisualRange AutoSideMargins="True"></VisualRange>
